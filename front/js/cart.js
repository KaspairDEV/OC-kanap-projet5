...
function affiche(indexé) {
    ...
    // les affichages des produits du panier via un map et introduction de dataset dans le code
...
if (page.match("cart")) {
  ...
  // on pointe des éléments input, on attribut à certains la même classe, ils réagiront pareil aux différantes regex
